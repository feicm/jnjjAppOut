$(function () {
    ...
    var listModule = {
        ...
        "urlRouter"      : {
            "v_car_list" : "resultlist.html", //结果页，列表形式
            "v_card_list": "resultlisttab.html" //结果页，tab列表形式
        },
        "resultUrl"      : 'infodetails.html',
                    ...
                    if ( msg !== 'NO_RESULT' ) {
                        ...
                        for ( var i = 0; i < al; i++ ) {
                            ...
                            li = [
                                ...
                                '    <span class="ui-seal m-list-c1-sts ' + (msg[i].clqk === "1" ? "dbn" : null) + '">未处理</span>',
