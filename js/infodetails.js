                ...
                case 'carquery': //车辆查询结果内容模板
                    if ( data.carList[0].msg !== 'NO_RESULT' ) {
                        ...
                        html=[
                            ...
                            '                    <div class="item-after">' + msg.jyyxqz + '</div>',
                            '                </div>',
                            '            </div>',
                            '        </li>',
                            '        <li>',
                            ...
                            '                    <div class="item-after">' + msg.qzbfqz + '</div>',
                            '                </div>',
                            '            </div>',
                            '        </li>',
                            '    </ul>',
                            ...
                            '                    <div class="item-after">' + msg.yqjyqzbfqz + '</div>',
                            '                </div>',
                            '            </div>',
                            '        </li>',
                            '        <li>',
                            ...
                            '                    <div class="item-after">' + msg.bxzzrq + '</div>',
                            '                </div>',
                            '            </div>',
                            '        </li>',
                            '        <li>',
                            ...
                            '                    <div class="item-after">' + msg.gxsj + '</div>',
                            '                </div>',
                            '            </div>',
                            '        </li>',
                            '    </ul>',
                ...
                case 'cardquery': //驾照查询结果内容模板
                    if ( data.licenseList[0].msg !== 'NO_RESULT' ) {
                        ...
                        html=[
                            ...
                            '                    <div class="item-after">' + msg.xyqfrq + '</div>',
                            '                </div>',
                            '            </div>',
                            '        </li>',
                            '        <li>',
                            ...
                            '                    <div class="item-after">' + msg.xysyrq + '</div>',
                            '                </div>',
                            '            </div>',
                            '        </li>',
                            '    </ul>',
